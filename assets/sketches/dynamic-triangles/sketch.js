...
function setup() {
	...
	// drawingWidth = canvasWidth - controlPane.width;
   ...
   createTriangles();
   changeCoords();
   // console.log(controlPane.borderCheckbox)
   // controlPane.borderCheckbox.changed(myCheckedEvent);
}
...
function createGrid(){
	...
	// console.log(numberOfNodesV, numberOfNodesW);
...
function changeNodeCoords(nodeObj) {
	...
	// console.log(nodeObj.transitionSpeed, tLower, tUpper)
}

function updateCoords() {
	_.map(nodes, function(node){
		// console.log(abs(node.deltaX * transitionSpeed))
