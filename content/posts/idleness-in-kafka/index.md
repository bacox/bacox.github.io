...
date: 2019-11-18
# author: ["Bart Cox","<a target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://tomdenottelander.com/\">Tom den Ottelander</a>"]
author: ["Bart Cox","<a target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://scholar.google.com/citations?user=M3xtprIAAAAJ\">Tom den Ottelander</a>"]
description: Minimizing idleness in Spark Clusters
# img: cpu_compare_small.png # Add image post (optional)
# fig-caption: # Add figcaption (optional)
tags: [kafka, streaming]
cover:
    image: "cpu_compare_small.png"
...
clusters](load_ratio_compare.png)
